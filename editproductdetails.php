    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Edit Products Details</h4>
                ...
                <form class="forms-sample row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" class="form-control" id="exampleInputEmail3" placeholder="Quantity">
                  </div>
                  <div class="form-group col-lg-6">
                    <label for="exampleInputName1">Model Name</label>
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Model Name">
                  </div>
                  <div class="form-group col-lg-6">
                    <label for="exampleInputEmail3">Rent</label>
                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Rent">
                  </div>
                  <div class="form-group col-lg-6">
                    <label for="">Product Image</label><br>
                    <img id="preview-image" src="" alt="preview-img">
