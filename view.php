        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addcustomers.html">Add Customers</a></li>
                <li class="nav-item"> <a class="nav-link" href="customerdetails.html">Customer Details</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="index.html">Order Details</a></li>
              </ul>
            </div>
          </li>
                      ...
                      <div class="col-md-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between" style="text-align:center">
                          <div class="card card-rounded">
                            <div class="card-body">
                              <p class="statistics-title">Name</p>
                              <h6>Rohit</h6>
                            </div>
                          </div>
                          <div class="card card-rounded">
                            <div class="card-body">
                              <p class="statistics-title">Staring Date</p>
                              <h6>17 Jan 2022</h6>
                            </div>
                          </div>
                          <div class="card card-rounded">
                            <div class="card-body">
                              <p class="statistics-title">Starting Time</p>
                              <h6>10-AM</h6>
                            </div>
                          </div>
                          <div class="card card-rounded">
                            <div class="card-body">
                              <p class="statistics-title">End Date</p>
                              <h6>20 Jan 2022</h6>
                            </div>
                          </div>
                          <div class="card card-rounded">
                            <div class="card-body">
                              <p class="statistics-title" >End Time</p>
                              <h6>5-PM</h6>
                            </div>
                          </div>
                          <div class="card card-rounded">
