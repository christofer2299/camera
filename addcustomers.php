                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample row" method="post" enctype="multipart/form-data" action="addcustomer-back.php">
                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <input type="tel" class="form-control" id="exampleInputEmail3" name="phone" placeholder="Mobile Number">
                    </div>
                    <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                      <label for="">Aadhaar Proof</label>
                      <input type="file" name="adhar_img" class="file" style="visibility:hidden">
