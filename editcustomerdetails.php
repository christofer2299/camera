    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Edit Customers Details</h4>
                ...
                <form class="forms-sample row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="tel" class="form-control" id="exampleInputEmail3" placeholder="Mobile Number">
                  </div>
                  <div class="form-group col-lg-6">
                  ...
                  <div class="form-group col-lg-6">
                    <label for="">Aadhaar Proof</label><br>
                    <img id="preview-aadhaar" src="" alt="preview-img">
                    <input type="file" name="img[]" class="file" style="visibility:hidden">
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" disabled placeholder="Upload Aadhaar File" aria-label="Upload File" aria-describedby="basic-addon1" required>
                  ...
                  <div class="form-group col-lg-6">
                    <label for="">Other Proof</label><br>
